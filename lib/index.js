...
var Sha, Walker, crypto, fs, pathlib;
...
Sha = (function() {
  ...
  function Sha(config) {
    ...
    cfg = (_ref = (_ref1 = this.config.plugins) != null ? _ref1.sha : void 0) != null ? _ref : {};
    for (k in cfg) {
      this.options[k] = cfg[k];
    }
  }

  Sha.prototype.brunchPlugin = true;

  Sha.prototype.onCompile = function() {
    var paths, walker,
      _this = this;
    paths = [];
    walker = new Walker;
  ...
  Sha.prototype.write = function(shasum) {
    return fs.writeFileSync(pathlib.join(this.config.paths["public"], this.options.shaFile), shasum);
  };
